...
<div class="row">
	<aui:fieldset cssClass="col-md-6">
		...
		<liferay-ui:error exception="<%= OrganizationNameException.class %>">
			...
			<liferay-ui:message arguments="<%= new String[] {organizationNameGeneralRestrictions, organizationNameReservedWords} %>" key="the-organization-name-cannot-be-x-or-a-reserved-word-x" translateArguments="<%= false %>" />
		</liferay-ui:error>
