...
public class JournalArticleIndexer
	...
	public void postProcessContextBooleanFilter(
		...
		// System.currentTimeMillis() is not testable at business layer
		//
		// Instead:
		// searchContext.getAttribute("??? JournalArticle.expiration ???")
		//
		// set the attribute at presentation layer where search is invoked
		//
		Date now = new Date(System.currentTimeMillis());

		// add(new RangeTermFilter(...)) without an end bound
		//
