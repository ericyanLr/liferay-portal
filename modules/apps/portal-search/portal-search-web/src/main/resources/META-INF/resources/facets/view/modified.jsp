...
String fieldParamFrom = ParamUtil.getString(request, HtmlUtil.escapeJS(facet.getFieldId()) + "from");
String fieldParamTo = ParamUtil.getString(request, HtmlUtil.escapeJS(facet.getFieldId()) + "to");

Date fromDate = null;
Date toDate = null;

if ((fieldParamFrom != null) || (fieldParamTo != null)) {
