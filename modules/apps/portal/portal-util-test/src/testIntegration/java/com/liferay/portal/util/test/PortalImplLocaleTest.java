	...
	private MockHttpServletResponse _testLocaleForLanguageId(
		...
		if (Validator.isNotNull(i18nLanguageId)) {
			mockHttpServletRequest.setPathInfo(
				pathInfo.substring(pathInfo.indexOf(CharPool.SLASH, 1)));
			mockHttpServletRequest.setRequestURI(pathInfo);
			mockHttpServletRequest.setServletPath(
				pathInfo.substring(0, pathInfo.indexOf(CharPool.SLASH, 1)));
		}
