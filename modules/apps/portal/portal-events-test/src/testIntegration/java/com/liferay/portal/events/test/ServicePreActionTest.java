...
public class ServicePreActionTest {
	...
	public void testErrorPage() throws Exception {
		...
		InstancePool.put(TestAction.class.getName(), testAction);
		...
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			testAction.includeJspException = true;
	...
	private class TestAction implements LifecycleAction {
		...
		public void processLifecycleEvent(LifecycleEvent lifecycleEvent)
			...
			String message = ServicePreActionTest.class.getName();

			if (includeJspException) {
				HttpServletRequest httpServletRequest =
					lifecycleEvent.getRequest();

				httpServletRequest.setAttribute(
					"javax.servlet.error.exception",
					new ActionException(message + "_JspException"));
			}

			throw new ActionException(message);
		}

		public boolean includeJspException;
